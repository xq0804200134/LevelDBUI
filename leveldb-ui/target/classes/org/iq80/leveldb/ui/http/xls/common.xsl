...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:variable name="strings" select="document(concat('strings_en','.xml'))"/>
         ...
         <tr>
            <td>
               <div align="center" class="footer">
                  <a href="https://github.com/dain/leveldb">LevelDb-UI</a>
               </div>
            </td>
         </tr>
      </table>
   ...
   <xsl:template name="tabs">
      ...
      <xsl:variable name="view.class">
         <xsl:choose>
            <xsl:when test="$selection='index'">fronttab</xsl:when>
            <xsl:otherwise>backtab</xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
      
      <xsl:variable name="operation.class">
         <xsl:choose>
            <xsl:when test="$selection='operation'">fronttab</xsl:when>
            <xsl:otherwise>backtab</xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
      ...
      <table cellpadding="0" cellspacing="0" border="0">
         <tr>
            <td class="{$view.class}">
            	<a href="/index" class="tabs">
                  <xsl:call-template name="str">
                     <xsl:with-param name="id">common.tabs.db.view</xsl:with-param>
                  </xsl:call-template>
                  </a>
            </td>
            <td width="2"/>
            ...
            <td class="{$operation.class}">
             	<a href="/operation" class="tabs">
                  <xsl:call-template name="str">
                     <xsl:with-param name="id">common.tabs.db.operation</xsl:with-param>
                  </xsl:call-template>
                 </a>
            </td>
            <td width="2"/>
